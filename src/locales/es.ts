...
export const translations: Translations = {
	...
	audit: {
		...
		fallbackSummary: "Acción ejecutada: {action}",
		searchPlaceholder: "Buscar por acción, resumen, entidad o usuario…",
		filterAllActions: "Todas las acciones",
		filterAllEntities: "Todas las entidades",
		filterAllUsers: "Todos los usuarios",
		userSearchPlaceholder: "Buscar usuario por nombre o correo…",
		...
		actions: {
			...
			PROJECT_OWNERSHIP_TRANSFERRED: "Propiedad transferida",
			MEMBER_INVITED: "Miembro invitado",
			MEMBER_INVITE_ACCEPTED: "Invitación aceptada",
			...
			CODE_CREATED: "Código creado",
			CODE_UPDATED: "Código actualizado",
			CODE_DELETED: "Código eliminado",
			QUOTE_CREATED: "Cita creada",
			QUOTE_COLOR_UPDATED: "Color de cita actualizado",
			QUOTE_DELETED: "Cita eliminada",
			QUOTE_CODE_ASSIGNED: "Código asignado a cita",
			QUOTE_CODE_REMOVED: "Código eliminado de cita",
			MEMO_CREATED: "Memorando creado",
			MEMO_UPDATED: "Memorando actualizado",
			MEMO_DELETED: "Memorando eliminado",
			DOCUMENT_UPLOADED: "Documento subido",
			DOCUMENT_PDF_ATTACHED: "PDF adjuntado al documento",
			BIBTEX_IMPORTED: "BibTeX importado",
			DOCUMENT_ENRICHMENT_SCHEDULED: "Enriquecimiento del documento programado",
			CODE_COMMENT_ADDED: "Comentario agregado al código",
			CODE_COMMENT_DELETED: "Comentario eliminado del código",
			QUOTE_COMMENT_ADDED: "Comentario agregado a la cita",
			QUOTE_COMMENT_DELETED: "Comentario eliminado de la cita",
		},
		entities: {
			PROJECT: "Proyecto",
			PROJECT_MEMBER: "Miembro",
			DOCUMENT: "Documento",
			CODE: "Código",
			QUOTE: "Cita",
			QUOTE_CODE: "Cita-Código",
			MEMO: "Memorando",
		},
	},
	...
	reports: {
		...
		explorer: "Explorador",
		charts: "Gráficos",
		analysis: "Laboratorio de Análisis",
		export: "Exportar",
		...
		matrixTitle: "Matriz Analítica (Códigos × Documentos)",
		agreementTitle: "Concordancia Entre Codificadores",
		selectCode: "Selecciona un código",
		selectCoderA: "Selecciona codificador A",
		selectCoderB: "Selecciona codificador B",
		kappa: "Kappa de Cohen",
		observedAgreement: "Concordancia observada",
		units: "Unidades",
		savedQueriesTitle: "Consultas Guardadas",
		savedQueryName: "Nombre de la consulta",
		savedQueryDefaultName: "Consulta guardada",
		saveQuery: "Guardar consulta",
		selectSavedQuery: "Selecciona una consulta guardada",
		savedQueryResults: "Citas resultantes",
	},
	...
	memos: {
		...
		quotePicker: "Insertar referencia de cita",
		quotePickerSearch: "Buscar citas…",
		quotePickerEmpty: "No se encontraron citas.",
	},
