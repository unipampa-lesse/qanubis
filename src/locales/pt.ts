...
export const translations: Translations = {
	...
	audit: {
		...
		fallbackSummary: "Ação executada: {action}",
		searchPlaceholder: "Buscar por ação, resumo, entidade ou usuário…",
		filterAllActions: "Todas as ações",
		filterAllEntities: "Todas as entidades",
		filterAllUsers: "Todos os usuários",
		userSearchPlaceholder: "Buscar usuário por nome ou e-mail…",
		...
		actions: {
			...
			PROJECT_OWNERSHIP_TRANSFERRED: "Propriedade transferida",
			MEMBER_INVITED: "Membro convidado",
			MEMBER_INVITE_ACCEPTED: "Convite aceito",
			MEMBER_ROLE_UPDATED: "Função de membro atualizada",
			...
			CODE_UPDATED: "Código atualizado",
			CODE_DELETED: "Código excluído",
			QUOTE_CREATED: "Citação criada",
			QUOTE_COLOR_UPDATED: "Cor da citação atualizada",
			QUOTE_DELETED: "Citação excluída",
			QUOTE_CODE_ASSIGNED: "Código atribuído à citação",
			QUOTE_CODE_REMOVED: "Código removido da citação",
			MEMO_CREATED: "Memorando criado",
			MEMO_UPDATED: "Memorando atualizado",
			MEMO_DELETED: "Memorando excluído",
			DOCUMENT_UPLOADED: "Documento enviado",
			DOCUMENT_PDF_ATTACHED: "PDF anexado ao documento",
			BIBTEX_IMPORTED: "BibTeX importado",
			DOCUMENT_ENRICHMENT_SCHEDULED: "Enriquecimento do documento agendado",
			CODE_COMMENT_ADDED: "Comentário adicionado ao código",
			CODE_COMMENT_DELETED: "Comentário removido do código",
			QUOTE_COMMENT_ADDED: "Comentário adicionado à citação",
			QUOTE_COMMENT_DELETED: "Comentário removido da citação",
		},
		entities: {
			PROJECT: "Projeto",
	...
	reports: {
		...
		explorer: "Explorador",
		charts: "Gráficos",
		analysis: "Laboratório de Análise",
		export: "Exportar",
		...
		agreementTitle: "Concordância Entre Codificadores",
		selectCode: "Selecione um código",
		selectCoderA: "Selecione codificador A",
		selectCoderB: "Selecione codificador B",
		kappa: "Kappa de Cohen",
		observedAgreement: "Concordância observada",
		units: "Unidades",
		savedQueriesTitle: "Consultas Salvas",
		savedQueryName: "Nome da consulta",
		savedQueryDefaultName: "Consulta salva",
		saveQuery: "Salvar consulta",
		selectSavedQuery: "Selecione uma consulta salva",
		savedQueryResults: "Citações retornadas",
	},
